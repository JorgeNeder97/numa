...
const EditIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    ...
    <path d="M14.91 4.1499C15.58 6.5399 17.45 8.4099 19.85 9.0899" stroke="#292D32" strokeWidth={1.5} strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
};
