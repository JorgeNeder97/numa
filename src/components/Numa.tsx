const Numa = () => {
    ...
    return (
        <div className="w-full text-tertiary flex flex-col place-items-center place-content-center gap-[30vh] translate-y-[-10vh] md:py-[100px]">
            <div className="text-[1.125rem] flex flex-col place-content-center place-items-center gap-[5px]">
                ...
                <div className="fromCenter w-[200px] lg:w-[400px] border-b-2 pt-[1px] border-tertiary"></div>
