    ...
    return (
        <div className="w-full min-h-[calc(100vh-50px)] bg-backgroundMockup flex flex-col place-items-center place-content-center gap-[5vh] lg:gap-[10vh]">
            <div className="flex flex-col place-items-center place-content-center gap-[20px] lg:gap-[30px] text-primary">
                <h3 className="fromTop font-bold text-[2rem] lg:text-[2.5rem]">
                    Invertí en vos hoy
                </h3>
                <span className="fromTop font-light tracking-wide leading-[22px] text-center text-[1rem] lg:text-[1.2rem] w-[270px] lg:w-[320px] lg:leading-[24px]">
            ...
            <Link
                ...
                className="fromTop text-[1rem] lg:text-[1.3rem] primary-button py-[8px] w-[45vw] max-w-[180px] lg:max-w-[220px] min-h-[25px] h-[40px] lg:h-[50px] flex place-content-center place-items-center"
            >
                {loading ? (
