...
const CarouselSmall = ({testimonios} : { testimonios: Testimonio[]}) => {
    ...
    return (
        <div className="fromCenter w-[90%] bg-almostwhite sm:w-[60%] lg:max-w-[600px] h-[218px] px-[15px] py-[25px] flex flex-col gap-[20px] place-items-center rounded-md shadow-card-center">
